...
<form method="POST" action="<?php echo e(url('search-students')); ?>">
	<div class="padded-full">
		...
		<input type="text" name="search" placeholder="Search Students" autocomplete="off" required/>
	</div>
	<div class="padded-full">
		...
		<?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<li>
				<a href="<?php echo e(url('view-student', $student->id)); ?>">
					...
					<?php echo e($student->name); ?> <?php echo e($student->class); ?> <strong>Adm.</strong> <?php echo e($student->admission->adm_no); ?><?php if(count($student->kcpe)>0): ?> <?php echo e($student->kcpe->marks); ?> <?php endif; ?>
				</a>
