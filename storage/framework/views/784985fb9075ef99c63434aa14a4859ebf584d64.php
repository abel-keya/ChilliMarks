...
<form method="POST" action="<?php echo e(url('create-all-exams')); ?>">
	...
	<div class="padded-full">
		<input type="text" name="exam_name" value="<?php echo e(old('exam_name')); ?>" autocomplete="off" placeholder="Enter Exam Name" autofocus>
	</div>
	<div class="padded-full">
		<select name="period">
